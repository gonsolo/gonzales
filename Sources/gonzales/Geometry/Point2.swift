...
extension Point2 where T: BinaryInteger {
        init(from: Point2I)     { self.init(x: T(from.x), y: T(from.y)) }
        init(from: Vector2<T>)  { self.init(x: T(from.x), y: T(from.y)) }
        init(from: Point2F)     { self.init(x: T(from.x), y: T(from.y)) }
        init(from: Vector2F)    { self.init(x: T(from.x), y: T(from.y)) }
}
