...
For Swift 6.1.2 and later the following has to be done on Arch Linux because of an [incompatibility with GCC 15](https://github.com/swiftlang/swift/issues/81774):
