...
let brassRefractiveIndices = PiecewiseLinearSpectrum(
        ...
        values: [
                1.358, 1.388, 1.419, 1.446, 1.473, 1.494, 1.504, 1.503, 1.497, 1.487, 1.471, 1.445, 1.405,
                1.350,
                1.278, 1.191, 1.094, 0.994, 0.900, 0.816, 0.745, 0.686, 0.639, 0.602, 0.573, 0.549, 0.527,
                0.505,
                0.484, 0.468, 0.460, 0.450, 0.452, 0.449, 0.445, 0.444, 0.444, 0.445, 0.444, 0.444, 0.445,
                0.446,
                0.448, 0.450, 0.452, 0.455, 0.457, 0.458, 0.460, 0.464, 0.469, 0.473, 0.478, 0.481, 0.483,
                0.486,
...
let brassExtinctionCoefficients = PiecewiseLinearSpectrum(
        lambdas: brassWavelengths,
        values: [
                1.688, 1.731, 1.764, 1.789, 1.807, 1.815, 1.815, 1.815, 1.818, 1.818, 1.813, 1.805, 1.794,
                1.786,
                1.784, 1.797, 1.829, 1.883, 1.957, 2.046, 2.145, 2.250, 2.358, 2.464, 2.568, 2.668, 2.765,
                2.860,
                2.958, 3.059, 3.159, 3.253, 3.345, 3.434, 3.522, 3.609, 3.695, 3.778, 3.860, 3.943, 4.025,
                4.106,
                4.186, 4.266, 4.346, 4.424, 4.501, 4.579, 4.657, 4.737, 4.814, 4.890, 4.965, 5.039, 5.115,
                5.192,
...
let goldWavelengths: [Real] = [
        298.75705, 302.400421, 306.133759, 309.960449, 313.884003, 317.908142, 322.036835,
        326.274139, 330.624481, 335.092377, 339.682678, 344.400482, 349.251221, 354.240509,
        359.37442, 364.659332, 370.10202, 375.709625, 381.489777, 387.450562, 393.600555,
        399.948975, 406.505493, 413.280579, 420.285339, 427.531647, 435.032196, 442.800629,
        450.851562, 459.200653, 467.864838, 476.862213, 486.212463, 495.936707, 506.057861,
        516.600769, 527.592224, 539.061646, 551.040771, 563.564453, 576.670593, 590.400818,
        604.800842, 619.920898, 635.816284, 652.548279, 670.184753, 688.800964, 708.481018,
        729.318665, 751.41925, 774.901123, 799.897949, 826.561157, 855.063293, 885.601257,
]
let goldRefractiveIndices = PiecewiseLinearSpectrum(
        lambdas: goldWavelengths,
        values: [
                1.795, 1.812, 1.822625, 1.83, 1.837125, 1.84, 1.83425,
                1.824, 1.812, 1.798, 1.782, 1.766, 1.7525, 1.74,
                1.727625, 1.716, 1.705875, 1.696, 1.68475, 1.674, 1.666,
                1.658, 1.64725, 1.636, 1.628, 1.616, 1.59625, 1.562,
                1.502125, 1.426, 1.345875, 1.242, 1.08675, 0.916, 0.7545,
                0.608, 0.49175, 0.402, 0.3455, 0.306, 0.267625, 0.236,
                0.212375, 0.194, 0.17775, 0.166, 0.161, 0.16, 0.160875,
                0.164, 0.1695, 0.176, 0.181375, 0.188, 0.198125, 0.21,
        ]
)
let goldExtinctionCoefficients = PiecewiseLinearSpectrum(
        lambdas: goldWavelengths,
        values: [
                1.920375, 1.92, 1.918875, 1.916, 1.911375, 1.904, 1.891375,
                1.878, 1.86825, 1.86, 1.85175, 1.846, 1.84525, 1.848,
                1.852375, 1.862, 1.883, 1.906, 1.9225, 1.936, 1.94775,
                1.956, 1.959375, 1.958, 1.951375, 1.94, 1.9245, 1.904,
                1.875875, 1.846, 1.814625, 1.796, 1.797375, 1.84, 1.9565,
                2.12, 2.32625, 2.54, 2.730625, 2.88, 2.940625, 2.97,
                3.015, 3.06, 3.07, 3.15, 3.445812, 3.8, 4.087687,
                4.357, 4.610188, 4.86, 5.125813, 5.39, 5.63125, 5.88,
        ]
)
