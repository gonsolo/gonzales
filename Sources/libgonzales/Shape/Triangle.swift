...
struct TriangleMesh {
        ...
        var cStruct: TriangleMesh_C {
                // All three withUnsafeBufferPointer calls must be nested so
                // that the buffers remain valid while TriangleMesh_C is constructed.
                return points.withUnsafeBufferPointer { pBuf in
